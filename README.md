...
A Windows tool for analyzing GitHub repositories and generating security-oriented reports.

Technologies: Python, GitHub API

# IndiCaps

A small Windows utility that displays the current state of the Caps Lock key.

Technologies: C#, .NET

# Zipdropper

A simple personal utility that i built for creating ZIP archives.
